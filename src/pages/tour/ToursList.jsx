...
import { Clock, HeartIcon, Star } from "lucide-react";
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {tours.map((destination, index) => (
                <div
                  key={index}
                  className="overflow-hidden border shadow-lg shadow-gray-500 rounded-lg flex flex-col"
                >
                  {/* Ảnh */}
                  <img
