...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      ...
      >
        <div
          className={`h-16 border-b border-gray-700 flex items-center ${
          ...
          {navGroups.map((group, index) => (
            <div key={index}>
              {isSidebarOpen && group.name && (
                <h3 className="px-2 pt-2 pb-1 text-xs font-semibold text-gray-400 uppercase tracking-wider">
                  {group.name}
                </h3>
              )}
          ...
          <div className="flex items-center">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 w-full md:w-64 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500"
              />
            </div>
          </div>
